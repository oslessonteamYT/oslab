...
sys_env_destroy(envid_t envid)
{
  ...
  80010c:	00 
  80010d:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  800114:	00 
  800115:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011c:	00 
  80011d:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800161:	e8 cb ff ff ff       	call   800131 <sys_getenvid>
  ...
  80017c:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  800192:	e8 51 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001d3:	e8 ca fe ff ff       	call   8000a2 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80023c:	e8 61 fe ff ff       	call   8000a2 <sys_cputs>
