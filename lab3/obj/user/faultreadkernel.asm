	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 b1 0e 80 00 	movsbl 0x800eb1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 c9 0e 80 	movl   $0x800ec9,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 d2 0e 80 	movl   $0x800ed2,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 c2 0e 80 00       	mov    $0x800ec2,%eax
