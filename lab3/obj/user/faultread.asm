...
exit(void)
{
  ...
  8000b2:	e8 5c 0a 00 00       	call   800b13 <sys_env_destroy>
}
  8000b7:	c9                   	leave  
  8000b8:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000e6:	e8 eb 09 00 00       	call   800ad6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80014f:	e8 82 09 00 00       	call   800ad6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 a8 0e 80 00 	movsbl 0x800ea8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 8d 40 0f 80 00 	jmp    *0x800f40(,%ecx,4)
  ...
  80043f:	c7 44 24 08 c9 0e 80 	movl   $0x800ec9,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 b9 0e 80 00       	mov    $0x800eb9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bb7:	e8 a0 f5 ff ff       	call   80015c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bbc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800bc0:	8b 45 10             	mov    0x10(%ebp),%eax
  800bc3:	89 04 24             	mov    %eax,(%esp)
  800bc6:	e8 30 f5 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800bcb:	c7 04 24 9c 0e 80 00 	movl   $0x800e9c,(%esp)
  800bd2:	e8 85 f5 ff ff       	call   80015c <cprintf>
