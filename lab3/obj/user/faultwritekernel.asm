...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016a:	e8 cb ff ff ff       	call   80013a <sys_getenvid>
  ...
  800185:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  80019b:	e8 51 00 00 00       	call   8001f1 <vcprintf>
	cprintf("\n");
  8001a0:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001dc:	e8 ca fe ff ff       	call   8000ab <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800245:	e8 61 fe ff ff       	call   8000ab <sys_cputs>
