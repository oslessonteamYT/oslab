...
sys_env_destroy(envid_t envid)
{
  ...
  80010d:	00 
  80010e:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  800115:	00 
  800116:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011d:	00 
  80011e:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017d:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  800193:	e8 51 00 00 00       	call   8001e9 <vcprintf>
	cprintf("\n");
  800198:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
