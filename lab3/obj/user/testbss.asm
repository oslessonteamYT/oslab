...
umain(int argc, char **argv)
{
  ...
  800039:	c7 04 24 20 0f 80 00 	movl   $0x800f20,(%esp)
  ...
  800058:	c7 44 24 08 9b 0f 80 	movl   $0x800f9b,0x8(%esp)
  80005f:	00 
  800060:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800067:	00 
  800068:	c7 04 24 b8 0f 80 00 	movl   $0x800fb8,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000a6:	c7 44 24 08 40 0f 80 	movl   $0x800f40,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 b8 0f 80 00 	movl   $0x800fb8,(%esp)
...
exit(void)
{
  ...
  800160:	e8 ae 0a 00 00       	call   800c13 <sys_env_destroy>
}
  800165:	c9                   	leave  
  800166:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800178:	e8 e8 0a 00 00       	call   800c65 <sys_getenvid>
  ...
  800193:	c7 04 24 e8 0f 80 00 	movl   $0x800fe8,(%esp)
  ...
  8001a9:	e8 51 00 00 00       	call   8001ff <vcprintf>
	cprintf("\n");
  8001ae:	c7 04 24 b6 0f 80 00 	movl   $0x800fb6,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001ea:	e8 e7 09 00 00       	call   800bd6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800253:	e8 7e 09 00 00       	call   800bd6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 9c 09 00 00       	call   800c90 <__udivdi3>
  ...
  80034f:	e8 6c 0a 00 00       	call   800dc0 <__umoddi3>
  800354:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800358:	0f be 80 0c 10 80 00 	movsbl 0x80100c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800473:	ff 24 8d a0 10 80 00 	jmp    *0x8010a0(,%ecx,4)
  ...
  80053f:	c7 44 24 08 2d 10 80 	movl   $0x80102d,0x8(%esp)
  800546:	00 
  ...
  800571:	b8 1d 10 80 00       	mov    $0x80101d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 20 12 80 	movl   $0x801220,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 3d 12 80 00 	movl   $0x80123d,(%esp)
  800c58:	e8 0a f5 ff ff       	call   800167 <_panic>
...
00800c90 <__udivdi3>:
  ...
  800c9a:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  800c9e:	8b 6c 24 20          	mov    0x20(%esp),%ebp
  800ca2:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  800ca6:	85 c0                	test   %eax,%eax
  800ca8:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800cac:	89 ea                	mov    %ebp,%edx
  800cae:	89 0c 24             	mov    %ecx,(%esp)
  800cb1:	75 2d                	jne    800ce0 <__udivdi3+0x50>
  800cb3:	39 e9                	cmp    %ebp,%ecx
  800cb5:	77 61                	ja     800d18 <__udivdi3+0x88>
  ...
  800cc4:	f7 f1                	div    %ecx
  800cc6:	89 c6                	mov    %eax,%esi
  800cc8:	31 d2                	xor    %edx,%edx
  800cca:	89 e8                	mov    %ebp,%eax
  800ccc:	f7 f6                	div    %esi
  800cce:	89 c5                	mov    %eax,%ebp
  800cd0:	89 f8                	mov    %edi,%eax
  800cd2:	f7 f6                	div    %esi
  800cd4:	89 ea                	mov    %ebp,%edx
  ...
  800ce0:	39 e8                	cmp    %ebp,%eax
  800ce2:	77 24                	ja     800d08 <__udivdi3+0x78>
  800ce4:	0f bd e8             	bsr    %eax,%ebp
  800ce7:	83 f5 1f             	xor    $0x1f,%ebp
  800cea:	75 3c                	jne    800d28 <__udivdi3+0x98>
  800cec:	8b 74 24 04          	mov    0x4(%esp),%esi
  800cf0:	39 34 24             	cmp    %esi,(%esp)
  800cf3:	0f 86 9f 00 00 00    	jbe    800d98 <__udivdi3+0x108>
  800cf9:	39 d0                	cmp    %edx,%eax
  800cfb:	0f 82 97 00 00 00    	jb     800d98 <__udivdi3+0x108>
  800d01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  800d08:	31 d2                	xor    %edx,%edx
  800d0a:	31 c0                	xor    %eax,%eax
  800d0c:	83 c4 0c             	add    $0xc,%esp
  800d0f:	5e                   	pop    %esi
  800d10:	5f                   	pop    %edi
  800d11:	5d                   	pop    %ebp
  800d12:	c3                   	ret    
  ...
  800d1a:	f7 f1                	div    %ecx
  800d1c:	31 d2                	xor    %edx,%edx
  800d1e:	83 c4 0c             	add    $0xc,%esp
  800d21:	5e                   	pop    %esi
  800d22:	5f                   	pop    %edi
  800d23:	5d                   	pop    %ebp
  800d24:	c3                   	ret    
  ...
  800d2a:	8b 3c 24             	mov    (%esp),%edi
  800d2d:	d3 e0                	shl    %cl,%eax
  800d2f:	89 c6                	mov    %eax,%esi
  800d31:	b8 20 00 00 00       	mov    $0x20,%eax
  800d36:	29 e8                	sub    %ebp,%eax
  800d38:	89 c1                	mov    %eax,%ecx
  800d3a:	d3 ef                	shr    %cl,%edi
  800d3c:	89 e9                	mov    %ebp,%ecx
  800d3e:	89 7c 24 08          	mov    %edi,0x8(%esp)
  800d42:	8b 3c 24             	mov    (%esp),%edi
  800d45:	09 74 24 08          	or     %esi,0x8(%esp)
  800d49:	89 d6                	mov    %edx,%esi
  800d4b:	d3 e7                	shl    %cl,%edi
  800d4d:	89 c1                	mov    %eax,%ecx
  800d4f:	89 3c 24             	mov    %edi,(%esp)
  800d52:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800d56:	d3 ee                	shr    %cl,%esi
  800d58:	89 e9                	mov    %ebp,%ecx
  800d5a:	d3 e2                	shl    %cl,%edx
  800d5c:	89 c1                	mov    %eax,%ecx
  800d5e:	d3 ef                	shr    %cl,%edi
  800d60:	09 d7                	or     %edx,%edi
  800d62:	89 f2                	mov    %esi,%edx
  800d64:	89 f8                	mov    %edi,%eax
  800d66:	f7 74 24 08          	divl   0x8(%esp)
  800d6a:	89 d6                	mov    %edx,%esi
  800d6c:	89 c7                	mov    %eax,%edi
  800d6e:	f7 24 24             	mull   (%esp)
  800d71:	39 d6                	cmp    %edx,%esi
  800d73:	89 14 24             	mov    %edx,(%esp)
  800d76:	72 30                	jb     800da8 <__udivdi3+0x118>
  800d78:	8b 54 24 04          	mov    0x4(%esp),%edx
  800d7c:	89 e9                	mov    %ebp,%ecx
  800d7e:	d3 e2                	shl    %cl,%edx
  800d80:	39 c2                	cmp    %eax,%edx
  800d82:	73 05                	jae    800d89 <__udivdi3+0xf9>
  800d84:	3b 34 24             	cmp    (%esp),%esi
  800d87:	74 1f                	je     800da8 <__udivdi3+0x118>
  800d89:	89 f8                	mov    %edi,%eax
  800d8b:	31 d2                	xor    %edx,%edx
  800d8d:	e9 7a ff ff ff       	jmp    800d0c <__udivdi3+0x7c>
  800d92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  800d98:	31 d2                	xor    %edx,%edx
  800d9a:	b8 01 00 00 00       	mov    $0x1,%eax
  800d9f:	e9 68 ff ff ff       	jmp    800d0c <__udivdi3+0x7c>
  800da4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800da8:	8d 47 ff             	lea    -0x1(%edi),%eax
...
00800dc0 <__umoddi3>:
  ...
  800dc1:	57                   	push   %edi
  800dc2:	56                   	push   %esi
  800dc3:	83 ec 14             	sub    $0x14,%esp
  800dc6:	8b 44 24 28          	mov    0x28(%esp),%eax
  800dca:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  800dce:	8b 74 24 2c          	mov    0x2c(%esp),%esi
  800dd2:	89 c7                	mov    %eax,%edi
  800dd4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800dd8:	8b 44 24 30          	mov    0x30(%esp),%eax
  800ddc:	89 4c 24 10          	mov    %ecx,0x10(%esp)
  800de0:	89 34 24             	mov    %esi,(%esp)
  800de3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800de7:	85 c0                	test   %eax,%eax
  800de9:	89 c2                	mov    %eax,%edx
  800deb:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800def:	75 17                	jne    800e08 <__umoddi3+0x48>
  800df1:	39 fe                	cmp    %edi,%esi
  800df3:	76 4b                	jbe    800e40 <__umoddi3+0x80>
  800df5:	89 c8                	mov    %ecx,%eax
  800df7:	89 fa                	mov    %edi,%edx
  800df9:	f7 f6                	div    %esi
  ...
  800e0a:	77 54                	ja     800e60 <__umoddi3+0xa0>
  800e0c:	0f bd e8             	bsr    %eax,%ebp
  800e0f:	83 f5 1f             	xor    $0x1f,%ebp
  800e12:	75 5c                	jne    800e70 <__umoddi3+0xb0>
  800e14:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800e18:	39 3c 24             	cmp    %edi,(%esp)
  800e1b:	0f 87 e7 00 00 00    	ja     800f08 <__umoddi3+0x148>
  800e21:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800e25:	29 f1                	sub    %esi,%ecx
  800e27:	19 c7                	sbb    %eax,%edi
  800e29:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800e2d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800e31:	8b 44 24 08          	mov    0x8(%esp),%eax
  800e35:	8b 54 24 0c          	mov    0xc(%esp),%edx
  ...
  800e70:	8b 04 24             	mov    (%esp),%eax
  800e73:	be 20 00 00 00       	mov    $0x20,%esi
  800e78:	89 e9                	mov    %ebp,%ecx
  800e7a:	29 ee                	sub    %ebp,%esi
  800e7c:	d3 e2                	shl    %cl,%edx
  800e7e:	89 f1                	mov    %esi,%ecx
  800e80:	d3 e8                	shr    %cl,%eax
  800e82:	89 e9                	mov    %ebp,%ecx
  800e84:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e88:	8b 04 24             	mov    (%esp),%eax
  800e8b:	09 54 24 04          	or     %edx,0x4(%esp)
  800e8f:	89 fa                	mov    %edi,%edx
  800e91:	d3 e0                	shl    %cl,%eax
  800e93:	89 f1                	mov    %esi,%ecx
  800e95:	89 44 24 08          	mov    %eax,0x8(%esp)
  800e99:	8b 44 24 10          	mov    0x10(%esp),%eax
  800e9d:	d3 ea                	shr    %cl,%edx
  800e9f:	89 e9                	mov    %ebp,%ecx
  800ea1:	d3 e7                	shl    %cl,%edi
  800ea3:	89 f1                	mov    %esi,%ecx
  800ea5:	d3 e8                	shr    %cl,%eax
  800ea7:	89 e9                	mov    %ebp,%ecx
  800ea9:	09 f8                	or     %edi,%eax
  800eab:	8b 7c 24 10          	mov    0x10(%esp),%edi
  800eaf:	f7 74 24 04          	divl   0x4(%esp)
  800eb3:	d3 e7                	shl    %cl,%edi
  800eb5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800eb9:	89 d7                	mov    %edx,%edi
  800ebb:	f7 64 24 08          	mull   0x8(%esp)
  800ebf:	39 d7                	cmp    %edx,%edi
  800ec1:	89 c1                	mov    %eax,%ecx
  800ec3:	89 14 24             	mov    %edx,(%esp)
  800ec6:	72 2c                	jb     800ef4 <__umoddi3+0x134>
  800ec8:	39 44 24 0c          	cmp    %eax,0xc(%esp)
  800ecc:	72 22                	jb     800ef0 <__umoddi3+0x130>
  800ece:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800ed2:	29 c8                	sub    %ecx,%eax
  800ed4:	19 d7                	sbb    %edx,%edi
  800ed6:	89 e9                	mov    %ebp,%ecx
  800ed8:	89 fa                	mov    %edi,%edx
  800eda:	d3 e8                	shr    %cl,%eax
  800edc:	89 f1                	mov    %esi,%ecx
  800ede:	d3 e2                	shl    %cl,%edx
  800ee0:	89 e9                	mov    %ebp,%ecx
  800ee2:	d3 ef                	shr    %cl,%edi
  800ee4:	09 d0                	or     %edx,%eax
  800ee6:	89 fa                	mov    %edi,%edx
  800ee8:	83 c4 14             	add    $0x14,%esp
  800eeb:	5e                   	pop    %esi
  800eec:	5f                   	pop    %edi
  800eed:	5d                   	pop    %ebp
  800eee:	c3                   	ret    
  800eef:	90                   	nop
  800ef0:	39 d7                	cmp    %edx,%edi
  800ef2:	75 da                	jne    800ece <__umoddi3+0x10e>
  800ef4:	8b 14 24             	mov    (%esp),%edx
  800ef7:	89 c1                	mov    %eax,%ecx
  800ef9:	2b 4c 24 08          	sub    0x8(%esp),%ecx
  800efd:	1b 54 24 04          	sbb    0x4(%esp),%edx
  800f01:	eb cb                	jmp    800ece <__umoddi3+0x10e>
  800f03:	90                   	nop
  800f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f08:	3b 44 24 0c          	cmp    0xc(%esp),%eax
  800f0c:	0f 82 0f ff ff ff    	jb     800e21 <__umoddi3+0x61>
  800f12:	e9 1a ff ff ff       	jmp    800e31 <__umoddi3+0x71>
