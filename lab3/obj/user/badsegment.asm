...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 db 00 00 00       	call   800136 <sys_getenvid>
  ...
  800072:	7e 07                	jle    80007b <libmain+0x3d>
		binaryname = argv[0];
  ...
  800076:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  80007b:	89 74 24 04          	mov    %esi,0x4(%esp)
  80007f:	89 1c 24             	mov    %ebx,(%esp)
  800082:	e8 ac ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  800087:	e8 07 00 00 00       	call   800093 <exit>
}
...
sys_env_destroy(envid_t envid)
{
  ...
  800111:	00 
  800112:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  800119:	00 
  80011a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800121:	00 
  800122:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
  800129:	e8 27 00 00 00       	call   800155 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800166:	e8 cb ff ff ff       	call   800136 <sys_getenvid>
  ...
  800181:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  800197:	e8 51 00 00 00       	call   8001ed <vcprintf>
	cprintf("\n");
  80019c:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001d8:	e8 ca fe ff ff       	call   8000a7 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800241:	e8 61 fe ff ff       	call   8000a7 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 be 0e 80 00 	movsbl 0x800ebe(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800463:	ff 24 8d 60 0f 80 00 	jmp    *0x800f60(,%ecx,4)
  ...
  80052f:	c7 44 24 08 df 0e 80 	movl   $0x800edf,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 cf 0e 80 00       	mov    $0x800ecf,%eax
