...
umain(int argc, char **argv)
{
  ...
  800064:	53                   	push   %ebx
  800065:	68 e0 10 80 00       	push   $0x8010e0
  ...
  80007c:	50                   	push   %eax
  80007d:	53                   	push   %ebx
  80007e:	68 f1 10 80 00       	push   $0x8010f1
  ...
  800096:	50                   	push   %eax
  800097:	e8 20 0d 00 00       	call   800dbc <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f1:	e8 9a 0c 00 00       	call   800e90 <__udivdi3>
  ...
  80022f:	e8 7c 0d 00 00       	call   800fb0 <__umoddi3>
  800234:	83 c4 14             	add    $0x14,%esp
  800237:	0f be 80 12 11 80 00 	movsbl 0x801112(%eax),%eax
  80023e:	50                   	push   %eax
...
0080028b <vprintfmt>:
{
  ...
  8002d7:	ff 24 85 e0 11 80 00 	jmp    *0x8011e0(,%eax,4)
  ...
  8003a3:	8b 14 85 40 13 80 00 	mov    0x801340(,%eax,4),%edx
  8003aa:	85 d2                	test   %edx,%edx
  8003ac:	74 18                	je     8003c6 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  8003ae:	52                   	push   %edx
  8003af:	68 33 11 80 00       	push   $0x801133
  8003b4:	53                   	push   %ebx
  8003b5:	56                   	push   %esi
  ...
  8003c6:	50                   	push   %eax
  8003c7:	68 2a 11 80 00       	push   $0x80112a
  8003cc:	53                   	push   %ebx
  8003cd:	56                   	push   %esi
  ...
  8003ee:	b8 23 11 80 00       	mov    $0x801123,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b57:	68 64 13 80 00       	push   $0x801364
  800b5c:	6a 23                	push   $0x23
  800b5e:	68 81 13 80 00       	push   $0x801381
  800b63:	e8 e1 02 00 00       	call   800e49 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be4:	e8 60 02 00 00       	call   800e49 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c1a:	68 64 13 80 00       	push   $0x801364
  800c1f:	6a 23                	push   $0x23
  800c21:	68 81 13 80 00       	push   $0x801381
  800c26:	e8 1e 02 00 00       	call   800e49 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	e8 dc 01 00 00       	call   800e49 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c9e:	68 64 13 80 00       	push   $0x801364
  800ca3:	6a 23                	push   $0x23
  800ca5:	68 81 13 80 00       	push   $0x801381
  800caa:	e8 9a 01 00 00       	call   800e49 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce0:	68 64 13 80 00       	push   $0x801364
  800ce5:	6a 23                	push   $0x23
  800ce7:	68 81 13 80 00       	push   $0x801381
  800cec:	e8 58 01 00 00       	call   800e49 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d44:	68 64 13 80 00       	push   $0x801364
  800d49:	6a 23                	push   $0x23
  800d4b:	68 81 13 80 00       	push   $0x801381
  800d50:	e8 f4 00 00 00       	call   800e49 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d65:	74 06                	je     800d6d <ipc_recv+0x18>
  800d67:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if (perm_store) *perm_store = 0;
  800d6d:	85 db                	test   %ebx,%ebx
  800d6f:	74 06                	je     800d77 <ipc_recv+0x22>
  800d71:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	if (!pg) pg = (void*) -1;
  800d77:	85 c0                	test   %eax,%eax
  800d79:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800d7e:	0f 44 c2             	cmove  %edx,%eax
	int ret = sys_ipc_recv(pg);
  800d81:	83 ec 0c             	sub    $0xc,%esp
  800d84:	50                   	push   %eax
  800d85:	e8 8a ff ff ff       	call   800d14 <sys_ipc_recv>
	if (ret) return ret;
  800d8a:	83 c4 10             	add    $0x10,%esp
  800d8d:	85 c0                	test   %eax,%eax
  800d8f:	75 24                	jne    800db5 <ipc_recv+0x60>
	if (from_env_store)
  800d91:	85 f6                	test   %esi,%esi
  800d93:	74 0a                	je     800d9f <ipc_recv+0x4a>
		*from_env_store = thisenv->env_ipc_from;
  800d95:	a1 04 20 80 00       	mov    0x802004,%eax
  800d9a:	8b 40 74             	mov    0x74(%eax),%eax
  800d9d:	89 06                	mov    %eax,(%esi)
	if (perm_store)
  800d9f:	85 db                	test   %ebx,%ebx
  800da1:	74 0a                	je     800dad <ipc_recv+0x58>
		*perm_store = thisenv->env_ipc_perm;
  800da3:	a1 04 20 80 00       	mov    0x802004,%eax
  800da8:	8b 40 78             	mov    0x78(%eax),%eax
  800dab:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  800dad:	a1 04 20 80 00       	mov    0x802004,%eax
  800db2:	8b 40 70             	mov    0x70(%eax),%eax
}
  800db5:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800db8:	5b                   	pop    %ebx
  800db9:	5e                   	pop    %esi
  800dba:	5d                   	pop    %ebp
  800dbb:	c3                   	ret    
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800dd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  800dd5:	0f 44 d8             	cmove  %eax,%ebx
	int ret;
  ...
  800ddc:	56                   	push   %esi
  800ddd:	57                   	push   %edi
  800dde:	e8 0e ff ff ff       	call   800cf1 <sys_ipc_try_send>
  800de3:	83 c4 10             	add    $0x10,%esp
  800de6:	85 c0                	test   %eax,%eax
  800de8:	74 1e                	je     800e08 <ipc_send+0x4c>
		if (ret == 0) break;
		if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
  800dea:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800ded:	75 07                	jne    800df6 <ipc_send+0x3a>
		sys_yield();
  800def:	e8 93 fd ff ff       	call   800b87 <sys_yield>
  800df4:	eb e2                	jmp    800dd8 <ipc_send+0x1c>
		if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
  800df6:	50                   	push   %eax
  800df7:	68 8f 13 80 00       	push   $0x80138f
  800dfc:	6a 36                	push   $0x36
  800dfe:	68 a6 13 80 00       	push   $0x8013a6
  800e03:	e8 41 00 00 00       	call   800e49 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800e1b:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800e1e:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800e24:	8b 52 50             	mov    0x50(%edx),%edx
  800e27:	39 ca                	cmp    %ecx,%edx
  800e29:	74 11                	je     800e3c <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  800e2b:	83 c0 01             	add    $0x1,%eax
  800e2e:	3d 00 04 00 00       	cmp    $0x400,%eax
  800e33:	75 e6                	jne    800e1b <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  800e35:	b8 00 00 00 00       	mov    $0x0,%eax
  800e3a:	eb 0b                	jmp    800e47 <ipc_find_env+0x37>
			return envs[i].env_id;
  800e3c:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e3f:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e4d:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800e4e:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e51:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e57:	e8 0c fd ff ff       	call   800b68 <sys_getenvid>
  800e5c:	83 ec 0c             	sub    $0xc,%esp
  800e5f:	ff 75 0c             	pushl  0xc(%ebp)
  800e62:	ff 75 08             	pushl  0x8(%ebp)
  800e65:	56                   	push   %esi
  800e66:	50                   	push   %eax
  800e67:	68 b0 13 80 00       	push   $0x8013b0
  800e6c:	e8 1d f3 ff ff       	call   80018e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e71:	83 c4 18             	add    $0x18,%esp
  800e74:	53                   	push   %ebx
  800e75:	ff 75 10             	pushl  0x10(%ebp)
  800e78:	e8 c0 f2 ff ff       	call   80013d <vcprintf>
	cprintf("\n");
  800e7d:	c7 04 24 ef 10 80 00 	movl   $0x8010ef,(%esp)
  800e84:	e8 05 f3 ff ff       	call   80018e <cprintf>
  800e89:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800e8c:	cc                   	int3   
  800e8d:	eb fd                	jmp    800e8c <_panic+0x43>
  800e8f:	90                   	nop
